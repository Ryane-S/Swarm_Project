...
from solutions.my_drone_test import MyDroneTest
...
class Launcher:
    ...
    def __init__(self):
        ...
        self.team_info = TeamInfo() # Mettre les infos de la team dans solutions.team_info.yml
        self.eval_plan = EvalPlan() # On stocke ici les différentes Map sur lesquelles on souhaite évaluer les candidats

        # On ajoute les Maps avec les zones spéciales pour certaines
        ...
        eval_config = EvalConfig(map_type=MyMapIntermediate02) # Par défaut un round si non précisé
        self.eval_plan.add(eval_config=eval_config)
        ...
        # On initialise les différents agents et composantes du round
